...
#[doc = " <pre>"]
#[doc = ""]
#[doc = " Copyright \u{a9} 2008-2011 Kristian H\u{f8}gsberg"]
#[doc = " Copyright \u{a9} 2010-2011 Intel Corporation"]
#[doc = " Copyright \u{a9} 2012-2013 Collabora, Ltd."]
#[doc = ""]
...
#[doc = " renderer in use."]
#[doc = ""]
#[doc = " The drm format codes match the macros defined in drm_fourcc.h."]
#[doc = " The formats actually supported by the compositor will be"]
#[doc = " reported by the format event."]
...
pub struct wl_data_offer_interface {
    ...
    #[doc = " drag source will receive wl_drag_source.cancelled."]
    #[doc = ""]
...
#[doc = " (source actions \u{2229} destination actions)."]
#[doc = ""]
...
pub struct wl_surface_interface {
    ...
    #[doc = ""]
    #[doc = " Alternatively, damage can be posted with"]
    #[doc = " wl_surface.damage_buffer which uses buffer coordinates instead"]
    #[doc = " of surface coordinates, and is probably the preferred and"]
    #[doc = " intuitive way of doing this."]
    #[doc = " @param x surface-local x coordinate"]
    #[doc = " @param y surface-local y coordinate"]
