...
use crate::{dom, DakotaId, DakotaObjectType, Output, SubsurfaceOrder};
...
pub struct Scene {
    ...
    pub d_layout_nodes: ll::Component<LayoutNode>,
    // NOTE: --------------------------------
    //
    ...
    pub d_needs_redraw: bool,
    pub d_needs_refresh: bool,
...
impl Scene {
    ...
    pub fn recompile(&mut self, output: &Output) -> Result<()> {
        ...
        self.d_window_dims = output.get_resolution();
    ...
    pub(crate) fn viewport_at_pos(&self, x: i32, y: i32) -> DakotaId {
